...
## GOVTECH NER MODEL
pretrained_model_folder_path = 'C:/Users/user/Downloads/bert-ner-main/bert-ner-main/bert_ner_address/'

hyperparameter_set = {}
ner = BertNER(**hyperparameter_set)

model = BertNERModel.from_pretrained(os.path.join(pretrained_model_folder_path, 'trained_model'))
tok_name = 'C:/Users/user/Downloads/bert-ner-main/bert-ner-main/bert_ner_address/'
